...
def main(demo=False):
  ...
  cloudlog.warning("waiting for first main camera frame")
  while buf_main is None:
    buf_main = vipc_client_main.recv(timeout_ms=500)
    meta_main = FrameMeta(vipc_client_main)
  cloudlog.warning("received first main camera frame")
